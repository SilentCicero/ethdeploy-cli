# Contributing to ethdeploy-cli

Love ethdeploy-cli and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/silentcicero/ethdeploy-cli/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/ethdeploy-cli.git
   # Navigate to the newly cloned directory
   cd ethdeploy-cli
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/silentcicero/ethdeploy-cli.git
   ```
